...
<template>
  <div class="flex h-full flex-col text-ink-primary">
    ...
    <div v-if="loading" class="flex flex-1 items-center justify-center text-sm text-ink-secondary">
      加载中...
    </div>
      ...
      <div class="flex flex-col gap-4">
        ...
        <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
          <label class="flex flex-col gap-1">
            <span class="center-row justify-start gap-1.5 text-sm text-ink-secondary">
        ...
        <div v-if="draft.type === 'openai'" class="rounded-[8px] border border-line bg-surface-hover p-3">
          <div class="flex items-center justify-between gap-3">
            <span class="center-row justify-start gap-1.5 text-sm text-ink-secondary">
              <Tooltip :content="fieldTips.openAIExtraParams" />
              <span>额外参数 JSON</span>
            </span>
            <label class="center-row gap-2 text-xs text-ink-secondary">
              <input
        ...
        <div v-if="draft.type === 'anthropic'" class="rounded-[8px] border border-line bg-surface-hover p-3">
          <div class="flex items-center justify-between gap-3">
            <span class="center-row justify-start gap-1.5 text-sm text-ink-secondary">
        ...
        <div class="rounded-[8px] border border-line bg-surface-hover p-3">
          <div class="flex items-center justify-between gap-3">
            <span class="center-row justify-start gap-1.5 text-sm text-ink-secondary">
        ...
        <label class="flex flex-col gap-1">
          ...
          <textarea
            ...
            class="min-h-[96px] resize-none rounded-[6px] border border-line-strong bg-surface-input px-3 py-2 text-sm text-ink-primary outline-none focus:border-brand-500"
          />
        </label>
