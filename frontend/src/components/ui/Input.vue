...
<template>
  <div class="relative w-full">
    <input
      ...
      :disabled="disabled"
      class="h-9 w-full rounded-md border border-line-strong bg-surface-input px-3 text-sm text-ink-primary outline-none transition-colors placeholder:text-ink-muted focus:border-brand-500 disabled:cursor-not-allowed disabled:opacity-60"
    ...
    <button
      ...
      type="button"
      class="absolute inset-y-0 right-0 center-row px-3 text-ink-muted transition-colors hover:text-ink-secondary focus:text-ink-secondary focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
