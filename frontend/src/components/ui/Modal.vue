    ...
    <Transition name="modal-mask">
      ...
      >
        <Transition name="modal-content">
          <div
            v-show="visible"
            class="relative z-10 w-full max-w-[360px] overflow-hidden rounded-lg border border-line bg-surface-card p-5 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.6)]"
            @click.stop
          >
            <div>
              ...
              <p class="mb-5 max-h-[55vh] overflow-y-auto whitespace-pre-wrap text-sm leading-relaxed text-ink-secondary">
                {{ content }}
              </p>
